...
import org.game.myDeployment.stackManagement.data.indexLifecyclePolicies.IlmPolicyImpl;
...
class IlmPolicyImplTests {
    public static IlmPolicyImpl ilmPolicyImpl;

    @BeforeAll
    static void setup() throws IOException {
        ilmPolicyImpl = new IlmPolicyImpl();
    }
