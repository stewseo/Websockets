...
// policy
// version
public class IlmPolicyHandler extends AbstractApiHandler {
    private static final Logger logger = LoggerFactory.getLogger(IlmPolicyHandler.class);
    ...
    public IlmPolicyHandler() throws IOException {
    ...
    public void setPipeline(Pipeline pipeline) {
        IlmPolicyHandler.websocketLogPipeline = pipeline;
    }
}
